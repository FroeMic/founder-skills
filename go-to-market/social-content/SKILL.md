...
When the user wants to keep drafts or a publishing plan:

- Save drafts under `.vertical/gtm/posts/YYYY-MM-DD-slug.md`
- Update `.vertical/gtm/social-calendar.md`
- Read `.vertical/gtm/content-ideas.md` when selecting ideas to turn into posts
- Do not write project-specific drafts into this source skills repo
